...
Q_CONSTINIT static const qt_meta_stringdata_RenderWidget_t qt_meta_stringdata_RenderWidget = {
    {
        ...
        QT_MOC_LITERAL(13, 11),  // "modelLoaded"
        QT_MOC_LITERAL(25, 0),  // ""
        QT_MOC_LITERAL(26, 8),  // "uint32_t"
        QT_MOC_LITERAL(35, 8),  // "vertices"
        QT_MOC_LITERAL(44, 9)   // "triangles"
    },
    "RenderWidget",
    "modelLoaded",
    "",
...
void RenderWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->modelLoaded((*reinterpret_cast< std::add_pointer_t<uint32_t>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<uint32_t>>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (RenderWidget::*)(uint32_t , uint32_t );
            if (_t _q_method = &RenderWidget::modelLoaded; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RenderWidget::modelLoaded(uint32_t _t1, uint32_t _t2)
{
