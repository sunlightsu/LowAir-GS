...
Q_CONSTINIT static const qt_meta_stringdata_RenderWidget_t qt_meta_stringdata_RenderWidget = {
    {
        ...
        QT_MOC_LITERAL(13, 10),  // "fpsUpdated"
        QT_MOC_LITERAL(24, 0),  // ""
        QT_MOC_LITERAL(25, 3)   // "fps"
    },
    "RenderWidget",
    "fpsUpdated",
    "",
...
void RenderWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->fpsUpdated((*reinterpret_cast< std::add_pointer_t<float>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (RenderWidget::*)(float );
            if (_t _q_method = &RenderWidget::fpsUpdated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RenderWidget::fpsUpdated(float _t1)
{
