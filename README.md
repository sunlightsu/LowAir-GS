...
> 独立目录 `apps/demo01_uav_scene_fusion/`，基于 Qt6 + OpenGL + UDP JSON
...
./apps/demo01_uav_scene_fusion/build/Demo01UavSceneFusion &
...
├── README.md
├── apps/
│   ├── demo01_uav_scene_fusion/            # Demo-01 Qt C++ 主程序
...
- [x] **Qt C++ 主程序**（`apps/demo01_uav_scene_fusion/`）
